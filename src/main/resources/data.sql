...
INSERT INTO session(id, publisher_id, exchange_id, name, publish_date, uuid) VALUES(1, 1, 1, 'Session1', NOW(), '8305d848-88d2-4cbd-a33b-5c3dcc548056');
INSERT INTO session(id, publisher_id, exchange_id, name, publish_date, uuid) VALUES(2, 1, 1, 'Session2', NOW(), '09628d25-ea42-490e-965d-cd4ffb6d4e9d');
INSERT INTO session(id, publisher_id, exchange_id, name, publish_date, uuid) VALUES(3, 2, 2, 'Session3', NOW(), '75f29692-237b-4116-95ed-645de5c57b4d');
